...
use CSP\GenericoBundle\Form\ProveedoresFilterType;
...
class ProveedoresController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('CSPGenericoBundle:Proveedores')
        ...
        if ($filterForm->get('reset')->isClicked()) {
            $session->remove('ProveedoresControllerFilter');
            $filterForm = $this->createFilterForm();
        }
        ...
        if ($filterForm->get('filter')->isClicked()) {
            if ($filterForm->isValid()) {
                ...
                $session->set('ProveedoresControllerFilter', $filterData);
            }
        } else {
            // Get filter from session
            if ($session->has('ProveedoresControllerFilter')) {
                $filterData = $session->get('ProveedoresControllerFilter');
    ...
    */
    ...
    {
        $form = $this->createForm(new ProveedoresFilterType(), $filterData, array(
            'action' => $this->generateUrl('proveedores'),
            'method' => 'GET',
        ));
     ...
     * @Method("POST")
     * @Template("CSPGenericoBundle:Proveedores:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $nextAction = $form->get('saveAndAdd')->isClicked()
                    ? $this->generateUrl('proveedores_new')
                    : $this->generateUrl('proveedores_show', array('id' => $entity->getId()));
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CSPGenericoBundle:Proveedores')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CSPGenericoBundle:Proveedores:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            $nextAction = $editForm->get('saveAndAdd')->isClicked()
                        ? $this->generateUrl('proveedores_new')
                        : $this->generateUrl('proveedores_show', array('id' => $id));
            return $this->redirect($nextAction);
        }
