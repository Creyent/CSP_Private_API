...
use CSP\GenericoBundle\Form\ProductosFilterType;
...
class ProductosController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('CSPGenericoBundle:Productos')
        ...
        if ($filterForm->get('reset')->isClicked()) {
            $session->remove('ProductosControllerFilter');
            $filterForm = $this->createFilterForm();
        }
        ...
        if ($filterForm->get('filter')->isClicked()) {
            if ($filterForm->isValid()) {
                ...
                $session->set('ProductosControllerFilter', $filterData);
            }
        } else {
            // Get filter from session
            if ($session->has('ProductosControllerFilter')) {
                $filterData = $session->get('ProductosControllerFilter');
    ...
    */
    ...
    {
        $form = $this->createForm(new ProductosFilterType(), $filterData, array(
            'action' => $this->generateUrl('productos'),
            'method' => 'GET',
        ));
     ...
     * @Method("POST")
     * @Template("CSPGenericoBundle:Productos:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $nextAction = $form->get('saveAndAdd')->isClicked()
                    ? $this->generateUrl('productos_new')
                    : $this->generateUrl('productos_show', array('id' => $entity->getId()));
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CSPGenericoBundle:Productos')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CSPGenericoBundle:Productos:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            $nextAction = $editForm->get('saveAndAdd')->isClicked()
                        ? $this->generateUrl('productos_new')
                        : $this->generateUrl('productos_show', array('id' => $id));
            return $this->redirect($nextAction);
        }
