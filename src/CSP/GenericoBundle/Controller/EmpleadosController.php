...
use CSP\GenericoBundle\Entity\Empleados;
use CSP\GenericoBundle\Form\EmpleadosType;
use CSP\GenericoBundle\Form\EmpleadosFilterType;
...
class EmpleadosController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('CSPGenericoBundle:Empleados')
        ...
        if ($filterForm->get('reset')->isClicked()) {
            $session->remove('EmpleadosControllerFilter');
            $filterForm = $this->createFilterForm();
        }
        ...
        if ($filterForm->get('filter')->isClicked()) {
            if ($filterForm->isValid()) {
                ...
                $session->set('EmpleadosControllerFilter', $filterData);
            }
        } else {
            // Get filter from session
            if ($session->has('EmpleadosControllerFilter')) {
                $filterData = $session->get('EmpleadosControllerFilter');
    ...
    */
    ...
    {
        $form = $this->createForm(new EmpleadosFilterType(), $filterData, array(
            'action' => $this->generateUrl('empleados'),
            'method' => 'GET',
        ));
     ...
     * @Method("POST")
     * @Template("CSPGenericoBundle:Empleados:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $nextAction = $form->get('saveAndAdd')->isClicked()
                    ? $this->generateUrl('empleados_new')
                    : $this->generateUrl('empleados_show', array('id' => $entity->getId()));
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CSPGenericoBundle:Empleados')->find($id);
     ...
     *
     * @Route("/{id}/edit", name="empleados_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CSPGenericoBundle:Empleados:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            $nextAction = $editForm->get('saveAndAdd')->isClicked()
                        ? $this->generateUrl('empleados_new')
                        : $this->generateUrl('empleados_show', array('id' => $id));
            return $this->redirect($nextAction);
        }
